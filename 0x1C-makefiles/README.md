...
```
https://github.com/Jaaystones/alx-low_level_programming/0x1C-makefiles.git
```

* Compile it with GCC
```
gcc -Wall -Werror -Wextra -pedantic -g *.c -o school
```
...
* Run with debugger
```
valgrind --leak-check=full --show-leak-kinds=all ./school
```
---
